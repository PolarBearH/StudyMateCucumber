...
public class UtilWaits {
    ...
    public static WebElement waiUntilElementIsVisible(WebDriver driver, int seconds, By locators) {
    ...
    public static List<WebElement> waitUntilAllElementsAreVisible (WebDriver driver, int seconds, By locators){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(seconds));
